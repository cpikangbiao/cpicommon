...
/**
 * REST controller for managing {@link com.cpi.common.domain.Company}.
 */
@RestController
@RequestMapping("/api")
public class CompanyResource {
    ...
    private static final String ENTITY_NAME = "cpicommonCompany";
    ...
    public ResponseEntity<List<CompanyDTO>> getAllCompanies(CompanyCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
