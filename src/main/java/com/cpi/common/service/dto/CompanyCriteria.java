...
/**
 * Criteria class for the {@link com.cpi.common.domain.Company} entity. This class is used
 * in {@link com.cpi.common.web.rest.CompanyResource} to receive all the possible filtering options from
...
public class CompanyCriteria implements Serializable, Criteria {
    ...
    public CompanyCriteria(CompanyCriteria other){
        ...
        this.companyNameChinese = other.companyNameChinese == null ? null : other.companyNameChinese.copy();
