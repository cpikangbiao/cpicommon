...
public class Correspondent implements Serializable {
    ...
    public Set<CorrespondentContact> getContacts() {
        return contacts;
    }

    public Correspondent contacts(Set<CorrespondentContact> correspondentContacts) {
        this.contacts = correspondentContacts;
        return this;
    }

    public Correspondent addContacts(CorrespondentContact correspondentContact) {
        this.contacts.add(correspondentContact);
        correspondentContact.setCorrespondent(this);
        return this;
    }

    public Correspondent removeContacts(CorrespondentContact correspondentContact) {
        this.contacts.remove(correspondentContact);
        correspondentContact.setCorrespondent(null);
        return this;
    }

    public void setContacts(Set<CorrespondentContact> correspondentContacts) {
        this.contacts = correspondentContacts;
    }
