...
/**
 * Integration tests for the {@Link CompanyNameHistoryResource} REST controller.
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, CpicommonApp.class})
public class CompanyNameHistoryResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static CompanyNameHistory createUpdatedEntity(EntityManager em) {
        CompanyNameHistory companyNameHistory = new CompanyNameHistory()
